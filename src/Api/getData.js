...
export const getDetection = async (file) => {
    try {
        const endpoint = 'https://sambraulio.cognitiveservices.azure.com/customvision/v3.0/Prediction/340f9803-5747-40db-b94a-38d39a177ece/detect/iterations/detectionv2/image';
